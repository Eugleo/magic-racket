...
- Updated LSP client, enabling new features including inlay hints (@dannypsnl)

## 0.8.0 (2025-10-14)

### Added

- Open macro stepper for selected syntax (@dannypsnl)
- Mention Rhombus support in README (@Anirban-001)

### Fixed

- Updated Node.js version used with GitHub actions (@jryans)
